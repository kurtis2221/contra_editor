/====================================\
|SuperC Editor 0.33a by Kurtis (2013)|
\====================================/

Information
===========
This editor is made for Super Contra (SuperC), Probotector 2 for the NES.
You can almost edit all levels, except level 2 and 6 and
only the level elements.
Enemies will appear at their default position.
...
- Copy your Super Contra (SuperC), Probotector 2 NES file
  to the editor's folder (where scontra_editor.exe is)
- Name your nes file to superc.nes
- Start contra_editor.exe

Other:
- If you want to change the NES file, delete data\superc.nes.dat
...
4. Change the ID, only change the length if you know what you're doing
